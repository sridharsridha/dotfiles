...
opts.initial = function()
	...
	opt.cmdheight = 0
	g.winblend = 0
	g.mapleader = require("config/global").mapleader
	g.maplocalleader = require("config/global").maplocalleader
	g.netrw_silent = require("config/global").netrw_silent
	g.disable_autoformat = require("config/global").disable_autoformat
	g.use_icons = require("config/global").use_icons
	-- Disable providers
